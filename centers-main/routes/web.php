...
Route::prefix('cms/admin/')->middleware('auth:admin,employee,trainer,student')->group(function(){
    ...
    Route::post('update_code/{id}' , [StudentController::class , 'update'])->name('update_students_code');
    ...
    Route::post('update_fileDiplomas/{id}' , [FileDiplomaController::class , 'update'])->name('update_fileDiplomas');
